...
* **NIC 2 (`ens4`) :** Connectée à un pont isolé (`virbr1` - `isolated-lan`) avec des adresses IP statiques (`10.10.10.11` à `10.10.10.15`). Utilisée pour la synchronisation sécurisée en peer-to-peer des nœuds Besu, les communications TLS et l'administration depuis l'hôte hyperviseur (`10.10.10.1`).
...
|-------------|--------------------|------|
| `validator-1` | `10.10.10.11` | Validateur QBFT |
| `validator-2` | `10.10.10.12` | Validateur QBFT |
| `validator-3` | `10.10.10.13` | Validateur QBFT |
| `validator-4` | `10.10.10.14` | Validateur QBFT |
| `rpc-node` | `10.10.10.15` | Nœud de lecture/écriture RPC / WS non-validateur |
